...
Shader "my/Effect/CenterBlur" {
    ...
    fixed4 fragCombine (v2f i) : COLOR
    {
        ...
        fixed dist = 1-length(float2(0.5, 0.5)-i.texcoord);
        ...
        col=lerp(col, blur,saturate(_fSampleStrength*_fSampleStrength*(dist)));
        return col;
    }
    ENDCG
